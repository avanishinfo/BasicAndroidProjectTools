...
/**
 *@author Avanish Singh  on 05/7/18.
 */
public class CheckPermission {
    ...
    public static void requestStoragePermission(Activity activity, int RC_STORAGE_PERMISSION) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ActivityCompat.requestPermissions(activity, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, RC_STORAGE_PERMISSION);
        } else {
            ActivityCompat.requestPermissions(activity, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, RC_STORAGE_PERMISSION);
        }
    }
     ...
     */
    public static void requestPhoneCallPermission(Activity activity, int RC_PHONE_CALL_PERMISSION) {
